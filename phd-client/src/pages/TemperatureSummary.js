...
import { getCountRequest } from '../actions/temperatureActions';

class TemperatureSummary extends Component {
...
render(){
  let colors = ['#AF2045', '#089631', '#033E6F'];
  return(
    <BackgroundImage>
    <ScrollView>
    <Text>{"\n"}</Text>
      ...
      <Text style={styles.patientText}>Mobile: {this.state.patientMobile}</Text>
        ...
        <Pie
           ...
           <Button
             ...
             onPress={()=>{ this.props.navigation.navigate('TemperatureKmeans')}}
           />
           </ScrollView>
    </ BackgroundImage>
  );
